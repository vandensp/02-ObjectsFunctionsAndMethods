...
def main():
    ...
    #even_better_draw_circles(rg.Point(100,50), 20, 10, 'blue', 15)
    #even_better_draw_circles(rg.Point(100,50), 20, 10, 'red', 5)

    even_better_draw_circles(rg.Point(100,50), 30, 10, 'red', 32)
    even_better_draw_circles(rg.Point(100, 50), 30, 10, 'green', 16)
    even_better_draw_circles(rg.Point(100, 50), 30, 10, 'blue', 8)
    even_better_draw_circles(rg.Point(100, 50), 30, 10, 'purple', 4)
    even_better_draw_circles(rg.Point(100, 50), 30, 10, 'yellow', 2)
...
def even_better_draw_circles(point, radius, circles, color, thickness):
    ...
    for k in range(circles):  # k becomes 1, 2, 3, ... 10
